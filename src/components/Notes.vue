<template>
    ...
    <div class="Notes">
        ...
        <ul id="notesList">
            ...
            <li v-for="note in notes" :key="note">
                <button
                    class="noteCheckbox noteButton material-symbols-outlined"
                    @click="editNoteComplete(note)">
                    <span
                        v-if="!note.isComplete"
                ...
                <button
                    class="noteButton material-symbols-outlined"
                    @click="editNoteBefore(note)">
                    edit
                </button>
                <button
                    class="noteButton material-symbols-outlined"
                ...
                <p :class="{ noteText: true, completeNote: note.isComplete }">
                    {{ note.content }}
                </p>
            </li>
        </ul>
    ...
    <div v-if="isEditing">
        <ChangeNotePopup
            :oldNote="noteToEdit"
            @popupClosed="(newNote) => editNoteAfter(newNote)" />
    </div>
</template>
